...
public class PacketHandler21R1 extends ChannelDuplexHandler {
    ...
    public PacketHandler21R1(final Player player, final PacketListener listener, final JavaPlugin plugin) {
        this.player = player;
