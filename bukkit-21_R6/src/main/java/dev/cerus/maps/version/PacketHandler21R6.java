...
public class PacketHandler21R6 extends ChannelDuplexHandler {
    ...
    public PacketHandler21R6(final Player player, final PacketListener listener, final JavaPlugin plugin) {
        this.player = player;
