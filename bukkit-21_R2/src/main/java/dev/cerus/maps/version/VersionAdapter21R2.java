...
public class VersionAdapter21R2 implements VersionAdapter {
    ...
    public void inject(final Player player, final PacketListener listener, final JavaPlugin plugin) {
        ...
        networkManager.n.pipeline().addBefore("packet_handler", "maps_listener", new PacketHandler21R2(player, listener, plugin));
    }
