...
public class PacketHandler21R2 extends ChannelDuplexHandler {
    ...
    public PacketHandler21R2(final Player player, final PacketListener listener, final JavaPlugin plugin) {
        this.player = player;
