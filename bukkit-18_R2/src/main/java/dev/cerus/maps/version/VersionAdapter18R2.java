...
public class VersionAdapter18R2 implements VersionAdapter {
    ...
    public void inject(final Player player, final PacketListener listener, final JavaPlugin plugin) {
        ((CraftPlayer) player).getHandle().b.a().m.pipeline()
                .addBefore("packet_handler", "maps_listener", new PacketHandler18R2(player, listener, plugin));
    }
    ...
    public boolean supportsVersion(MinecraftVersion version) {
        return version.equals(MinecraftVersion.RELEASE_1_18_2);
    }
}
