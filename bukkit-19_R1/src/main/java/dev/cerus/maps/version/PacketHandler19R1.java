...
public class PacketHandler19R1 extends ChannelDuplexHandler {
    ...
    public PacketHandler19R1(final Player player, final PacketListener listener, final JavaPlugin plugin) {
        this.player = player;
