...
public class PacketHandler18R2 extends ChannelDuplexHandler {
    ...
    public PacketHandler18R2(final Player player, final PacketListener listener, final JavaPlugin plugin) {
        this.player = player;
